...
function CharacterDelete() {
    $.post('https://_c/Client:Character:Delete', JSON.stringify({
        ID: Character_ID,
    }));
    $("#Sidebar").hide();
    $("#CharacterList").hide();
...
function CharacterJoin() {
    $.post('https://_c/Client:Character:Join', JSON.stringify({
        ID: Character_ID,
    }));
    $("#Sidebar").hide();
    $("#CharacterList").hide();
...
function CharacterMake() {
    ...
    $.post('https://_c/Client:Character:Create', JSON.stringify({
        First_Name: fn,
        Last_Name: ln,
        Height: cm,
        Birth_Date: dob,
