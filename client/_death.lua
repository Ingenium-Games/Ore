...
function PlayerKilledByPlayer(killerServerId, killerClientId, killerWeapon)
    ...
    local data = {
        VictimCoords = vector3(c.math.Decimals(victimCoords.x, 2), c.math.Decimals(victimCoords.y, 2),
            c.math.Decimals(victimCoords.z, 2)),
        KillerCoords = vector3(c.math.Decimals(killerCoords.x, 2), c.math.Decimals(killerCoords.y, 2),
            c.math.Decimals(killerCoords.z, 2)),
        --
        PlayerKill = true,
        Cause = killerWeapon,
